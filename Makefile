...
setup-spike:
	...
	docker exec -it ziggurat_kafka /opt/bitnami/kafka/bin/kafka-topics.sh --create --topic $(topic3) --partitions 1 --replication-factor 1 --zookeeper ziggurat_zookeeper
