...
func (dr *defaultRouter) HandleMessage(event Event, app AppContext) ProcessStatus {
...
func (dr *defaultRouter) HandleFunc(route string, handlerFunc func(event Event, app AppContext) ProcessStatus) {
	if handlerFunc == nil {
