...
var createAndBindQueues = func(c *amqp.Channel, topicEntities []string, prefix string) {
	declareExchanges(c, topicEntities, prefix)
	createInstantQueues(c, topicEntities, prefix)
	createDelayQueues(c, topicEntities, prefix)
	createDeadLetterQueues(c, topicEntities, prefix)
}
